...
for ins in range(N_INSTANCE):
    ...
    # mu_ad_x, mu_ad_w = empirical_k_means_measure(bms, use_klist=1, klist=np.arange(T)+1, use_weights=1)
    ...
    nu_ad_x, nu_ad_w = empirical_k_means_measure(bms_nu, use_weights=1)
